...
public class VillagerModel extends EntityModel<VillagerRenderState>
                implements HeadedModel, VillagerLikeModel<VillagerRenderState> {
        ...
        public static MeshDefinition createBodyModel() {
                ...
                PartDefinition head = root.addOrReplaceChild("head",
                                ...
                                PartPose.ZERO);
                PartDefinition hat = head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F,
                                -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.51F)), PartPose.ZERO);
                hat.addOrReplaceChild("hat_rim", CubeListBuilder.create().texOffs(30, 47).addBox(-8.0F, -8.0F, -6.0F,
                                16.0F, 16.0F, 1.0F), PartPose.rotation(-1.5707964F, 0.0F, 0.0F));
                ...
                PartDefinition body = root.addOrReplaceChild("body",
                                ...
                                PartPose.ZERO);
                body.addOrReplaceChild("jacket", CubeListBuilder.create().texOffs(0, 38).addBox(-4.0F, 0.0F, -3.0F,
                                8.0F, 20.0F, 6.0F, new CubeDeformation(0.5F)), PartPose.ZERO);
                ...
                root.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 22).mirror().addBox(-2.0F, 0.0F,
                                -2.0F, 4.0F, 12.0F, 4.0F), PartPose.offset(2.0F, 12.0F, 0.0F));
                return mesh;
        }
        ...
        public void setupAnim(final VillagerRenderState state) {
                ...
                this.rightLeg.xRot = Mth.cos((double) (state.walkAnimationPos * 0.6662F)) * 1.4F
                                * state.walkAnimationSpeed * 0.5F;
                this.leftLeg.xRot = Mth.cos((double) (state.walkAnimationPos * 0.6662F + 3.1415927F)) * 1.4F
                                * state.walkAnimationSpeed * 0.5F;
