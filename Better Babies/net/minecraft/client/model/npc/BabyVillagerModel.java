...
public class BabyVillagerModel extends VillagerModel {
    ...
    public static MeshDefinition createBodyModel() {
        ...
        arms.addOrReplaceChild("right_hand",
                CubeListBuilder.create().texOffs(36, 15).addBox(-1.0F, -2.7425F, -2.2731F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.25F))
                        .texOffs(16, 15).addBox(-3.0F, 1.4025F, -0.9599F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.25F)),
