...
public class BabyVillagerModel extends VillagerModel {
    ...
    public static MeshDefinition createBodyModel() {
        ...
        PartDefinition arms = root.addOrReplaceChild("arms", CubeListBuilder.create(),
                PartPose.offset(0.0F, 17.3F, 0.0F));
        arms.addOrReplaceChild("right_hand",
                CubeListBuilder.create().texOffs(36, 15).addBox(-1.5F, -2.7425F, -2.2731F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.25F))
                        .texOffs(16, 15).addBox(5.5F, -2.7425F, -2.2731F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.25F)),
                PartPose.offsetAndRotation(-3.0F, 1.4025F, -0.9599F, -1.0472F, 0.0F, 0.0F));
        arms.addOrReplaceChild("middlearm_r1",
                CubeListBuilder.create().texOffs(24, 17).addBox(-2.0F, -1.2424F, -1.4155F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.25F)),
                PartPose.offsetAndRotation(0.0F, 0.9024F, -1.8175F, -1.0472F, 0.0F, 0.0F));
        root.addOrReplaceChild("right_leg",
                CubeListBuilder.create().texOffs(8, 23).addBox(-1.5F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F),
                PartPose.offset(-0.5F, 21.5F, 0.0F));
        root.addOrReplaceChild("left_leg",
                CubeListBuilder.create().texOffs(0, 23).addBox(-0.5F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F),
                PartPose.offset(0.5F, 21.5F, 0.0F));
        PartDefinition head = root.addOrReplaceChild("head",
                CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.5F, -3.5F, 8.0F, 8.0F, 7.0F),
                PartPose.offset(0.0F, 15.5F, 0.0F));
        head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 30).addBox(-4.0F, -4.5F, -3.5F, 8.0F, 8.0F,
                7.0F, new CubeDeformation(0.3F)), PartPose.offset(0.0F, -4.0F, 0.0F));
        head.addOrReplaceChild("hat_rim",
                CubeListBuilder.create().texOffs(0, 45).addBox(-7.0F, -1.0F, -6.0F, 14.0F, 1.0F, 12.0F),
                PartPose.offset(0.0F, -4.5F, 0.0F));
        head.addOrReplaceChild("nose",
                CubeListBuilder.create().texOffs(23, 0).addBox(-1.0F, -1.5F, -0.5F, 2.0F, 3.0F, 1.0F),
