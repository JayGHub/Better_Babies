...
public record PartPose(float x, float y, float z, float xRot, float yRot, float zRot, float xScale, float yScale,
    ...
    public PartPose(float x, float y, float z, float xRot, float yRot, float zRot, float xScale, float yScale,
            float zScale) {
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public static PartPose offsetAndRotation(final float offsetX, final float offsetY, final float offsetZ,
    ...
    public PartPose translated(final float x, final float y, final float z) {
        return new PartPose(this.x + x, this.y + y, this.z + z, this.xRot, this.yRot, this.zRot, this.xScale,
    ...
    public PartPose scaled(final float scaleX, final float scaleY, final float scaleZ) {
        return new PartPose(this.x * scaleX, this.y * scaleY, this.z * scaleZ, this.xRot, this.yRot, this.zRot,
                this.xScale * scaleX, this.yScale * scaleY, this.zScale * scaleZ);
    }
